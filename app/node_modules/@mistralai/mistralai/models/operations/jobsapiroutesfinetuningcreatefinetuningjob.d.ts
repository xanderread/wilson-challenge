 ...
 * OK
 */
export type JobsApiRoutesFineTuningCreateFineTuningJobResponse = components.LegacyJobMetadataOut | components.JobOut;
/** @internal */
...
/** @internal */
export type JobsApiRoutesFineTuningCreateFineTuningJobResponse$Outbound = components.LegacyJobMetadataOut$Outbound | components.JobOut$Outbound;
/** @internal */

...
class PortkeySession {
    constructor(options = {}){
        if (!options.apiKey) {
            options.apiKey = env.getEnv("PORTKEY_API_KEY");
        }
        if (!options.baseURL) {
            options.baseURL = env.getEnv("PORTKEY_BASE_URL") ?? "https://api.portkey.ai";
        }
...
class Portkey extends llms.BaseLLM {
    static{
    ...
    constructor(init){
        super(), this.apiKey = undefined, this.baseURL = undefined, _initProto(this);

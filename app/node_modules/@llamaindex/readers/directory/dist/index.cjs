...
var index_cjs = require('../../csv/dist/index.cjs');
var index_edgeLight_js$3 = require('../../docx/dist/index.edge-light.js');
var index_edgeLight_js$4 = require('../../html/dist/index.edge-light.js');
var index_edgeLight_js$5 = require('../../image/dist/index.edge-light.js');
var index_edgeLight_js$2 = require('../../markdown/dist/index.edge-light.js');
var index_edgeLight_js$1 = require('../../pdf/dist/index.edge-light.js');
var index_edgeLight_js = require('../../text/dist/index.edge-light.js');
...
class AbstractSimpleDirectoryReader {
    ...
    async loadData(params) {
        ...
        const { directoryPath, defaultReader = new index_edgeLight_js.TextFileReader(), fileExtToReader, numWorkers = 1, overrideReader } = params;
...
const FILE_EXT_TO_READER = {
    txt: new index_edgeLight_js.TextFileReader(),
    pdf: new index_edgeLight_js$1.PDFReader(),
    csv: new index_cjs.CSVReader(),
    md: new index_edgeLight_js$2.MarkdownReader(),
    docx: new index_edgeLight_js$3.DocxReader(),
    htm: new index_edgeLight_js$4.HTMLReader(),
    html: new index_edgeLight_js$4.HTMLReader(),
    jpg: new index_edgeLight_js$5.ImageReader(),
    jpeg: new index_edgeLight_js$5.ImageReader(),
    png: new index_edgeLight_js$5.ImageReader(),
    gif: new index_edgeLight_js$5.ImageReader()
};
/**

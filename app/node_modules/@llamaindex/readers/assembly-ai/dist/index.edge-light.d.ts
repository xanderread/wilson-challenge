...
import { Document, BaseReader } from '@llamaindex/core/schema';

type AssemblyAIOptions = Partial<BaseServiceParams>;
/**
 * Base class for AssemblyAI Readers.
 */
declare abstract class AssemblyAIReader implements BaseReader<Document> {
...
export { type AssemblyAIOptions, AudioSubtitlesReader, AudioTranscriptParagraphsReader, AudioTranscriptReader, AudioTranscriptSentencesReader };

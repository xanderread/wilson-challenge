...
import type { CompletionResponse, LLMCompletionParamsNonStreaming, LLMCompletionParamsStreaming, LLMMetadata, ToolCall } from "@llamaindex/core/llms";
...
export declare class GeminiSession implements IGeminiSession {
    ...
    getToolsFromResponse(response: EnhancedGenerateContentResponse): ToolCall[] | undefined;

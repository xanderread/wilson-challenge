...
class SimpleIndexStore extends _KVIndexStore.KVIndexStore {
    ...
    static async fromPersistDir(persistDir = _global.DEFAULT_PERSIST_DIR) {
        const persistPath = _env.path.join(persistDir, _global.DEFAULT_INDEX_STORE_PERSIST_FILENAME);
    ...
    async persist(persistPath = _global.DEFAULT_PERSIST_DIR) {

...
class IngestionCache {
    ...
    async put(hash, nodes) {
        const val = {
            [this.nodesKey]: nodes.map((node)=>(0, _utils.docToJson)(node, _utils.jsonSerializer))
        };
    ...
    async get(hash) {
        ...
        return json[this.nodesKey].map((doc)=>(0, _utils.jsonToDoc)(doc, _utils.jsonSerializer));
    }
}

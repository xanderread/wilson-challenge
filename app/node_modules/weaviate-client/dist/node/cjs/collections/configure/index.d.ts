...
declare const configure: {
  ...
  vectorizer: {
    ...
    multi2VecPalm: <N_5 extends string | undefined = undefined, I_5 extends string = 'hnsw'>(
      opts: import('./types/vectorizer.js').ConfigureNonTextVectorizerOptions<N_5, I_5, 'multi2vec-palm'>
    ) => import('./types/vectorizer.js').VectorConfigCreate<never, N_5, I_5, 'multi2vec-palm'>;
    multi2VecGoogle: <N_6 extends string | undefined = undefined, I_6 extends string = 'hnsw'>(
      opts: import('./types/vectorizer.js').ConfigureNonTextVectorizerOptions<N_6, I_6, 'multi2vec-google'>
    ) => import('./types/vectorizer.js').VectorConfigCreate<never, N_6, I_6, 'multi2vec-google'>;
    ref2VecCentroid: <N_7 extends string | undefined = undefined, I_7 extends string = 'hnsw'>(
      opts: import('./types/vectorizer.js').ConfigureNonTextVectorizerOptions<N_7, I_7, 'ref2vec-centroid'>
    ) => import('./types/vectorizer.js').VectorConfigCreate<never, N_7, I_7, 'ref2vec-centroid'>;
    text2VecAWS: <T, N_8 extends string | undefined = undefined, I_8 extends string = 'hnsw'>(
      opts: import('./types/vectorizer.js').ConfigureTextVectorizerOptions<T, N_8, I_8, 'text2vec-aws'>
